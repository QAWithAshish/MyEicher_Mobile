...
public class FleetTrackStatusTestV1 extends GetPage {
    ...
    public void TrackLandingPageTabs() {
        ...
        getFleetTrackingScreenV1().goToOurServices()
 ...
 /*   @Test(priority = 2)
  ...
  /* @Test(priority = 3)
    ...
    public void SwitchListViewtoMapView() {
        ...
        getFleetTrackingScreenV1().navigateToHome();
    }*/
  ...
  /*  @Test(priority = 6)
    public void ValidateVehicleDetailsInListView() {
        ...
        getFleetTrackingScreenV1().validateVehicleReadings();
        getFleetTrackingScreenV1().navigateToHome();
    ...
    public void ValidateOneVehicleDetailsCategoriesInListView() {
        ...
        getFleetTrackingScreenV1().validateOneVehicleDetails().
    ...
    public void validateDetailedMapForIndividualVehicles() {
        ...
        if (driver.getCapabilities().getPlatformName().toString().equalsIgnoreCase(Platform.ANDROID.toString())) {
            ...
            getFleetTrackingScreenV1().openDetailedVehicleMap();
    ...
    public void validateVehicleSheetforMapCluster() {
        ...
        if (driver.getCapabilities().getPlatformName().toString().equalsIgnoreCase(Platform.ANDROID.toString())) {
            ...
            getFleetTrackingScreenV1().openClusterVehicleMap();
        } else {
            ExtentTestManager.getTest().log(Status.SKIP, "Test is not supported by iOS");
            throw new SkipException("Test is not available in iOS");
        }
    ...
    public void validateSearchFilter() {
        ...
        if (driver.getCapabilities().getPlatformName().toString().equalsIgnoreCase(Platform.ANDROID.toString())) {
            ...
            getFleetTrackingScreenV1().filterViewByVehicle();
            getFleetTrackingScreenV1().filterViewByLocation();
        } else {
            ExtentTestManager.getTest().log(Status.SKIP, "Test is not supported by iOS");
            throw new SkipException("Test is not available in iOS");
        }
...
/*
    ...
    @Test(priority = 12)
    public void validateSearchFilterWithCategorySwitch() {
        ...
        getFleetTrackingScreenV1().categorySwitchViewByVehicle();
    }
*/
  ...
  /*  @Test(priority = 14)
    public void ValidateAllRealTimeDetailsOfVehicle() {
    ...
    @Test(priority = 15)
    public void ValidateNoPioletAssigned() {
        startTest("Validate No Pilot Assigned", "If no pilot is assigned then text No Pilot Assigned should be visible. ");

        getFleetTrackingScreenV1().validateOneVehicleDetails().noPilotAssigned();

    }

   /* @Test(priority = 16)
    public void ValidateShareLiveLocation() {
    ...
    @Test(priority = 17)
    public void ValidateCurrentLiveLocation() {
