...
public class FleetTrackingScreen extends BasePage {

    public FleetTrackingScreen(AppiumDriver driver) {
        super(driver);
    ...
    @AndroidFindBy(id = "in.here.volvo.android:id/tv_done")
    ...
    @AndroidFindBy(id = "in.here.volvo.android:id/tv_apply_filter")
    ...
    @iOSXCUITFindBy(iOSClassChain = "**/XCUIElementTypeStaticText[`label == \"FLEET TRACKING\"`]")
    ...
    @AndroidFindBy(id = "in.here.volvo.android:id/rbFuelDrainFM")
    WebElement fsFuelDrain;
    ...
    @AndroidFindBy(xpath = "(//android.widget.TextView[@text='View by Vehicle'])[2]")
    ...
    @iOSXCUITFindBy(iOSClassChain = "**/XCUIElementTypeCell[`visible==1`]")
    @AndroidFindBy(xpath = "(//*[@resource-id='in.here.volvo.android:id/textView'])[1]")
    WebElement fsSelectRegNumber;

    @iOSXCUITFindBy(accessibility = "FUEL GRAPH")
    @AndroidFindBy(xpath = "//android.widget.TextView[@text='FUEL GRAPH']")
    WebElement qlFuelGraph;

    @AndroidFindBy(id = "in.here.volvo.android:id/ffFilter")
    ...
    @AndroidFindBy(id = "in.here.volvo.android:id/tvDone")
    WebElement filterByVehicleDoneBtn;

    @AndroidFindBy(id = "in.here.volvo.android:id/tvApplyFilter")
    ...
    @iOSXCUITFindBy(accessibility = "Fleet Monitor")
    @AndroidFindBy(id = "in.here.volvo.android:id/tvFleetMonitoring")
    WebElement fleetInsightBottomTab;

    @AndroidFindBy(xpath = "//android.widget.TextView[@text='GO TO DASHBOARD']")
    WebElement qlGotoDashboard;
    ...
    @AndroidFindBy(uiAutomator = "new UiSelector().resourceId(\"in.here.volvo.android:id/tv_pilot_name\").text(\"NO PILOT\")")
    @iOSXCUITFindBy(accessibility = "No Pilot Assigned")
    WebElement nopilotAssignedScenario;

    @AndroidFindBy(id = "in.here.volvo.android:id/et_search")
    WebElement locationSearchTF;

    @AndroidFindBy(accessibility = "Location")
    WebElement searchLocationButton;


    public FleetTrackingScreen quickLinksTabFleetInsight() {
        ...
        Assert.assertTrue(actions.iselementVisible(fleetInsightBottomTab), "Vehicle fleet insight at bottom is not display");
        return this;
    }
    public FleetTrackingScreen quickLinksTabFuelGraph() {
    ...
    public FleetTrackingScreen quickLinksTabFuelServices() {
        ...
        LogReporter.Reporter("Click on Search By Reg Num");
        fsSelectRegNumber.click();
        ScreenShotUtils.attachScreenshot();
    ...
    //Need to discussion on this tc-33
    public FleetTrackingScreen quickLinksTabVehicleDetails() {
    ...
    public FleetTrackingScreen shareVehicleCurrentLocation() throws InterruptedException {
    ...
    public FleetTrackingScreen shareVehicleLiveLocation() throws InterruptedException {
        Assert.assertTrue(actions.iselementVisible(bottomSheetToggle));
        actions.pullUpBottomSheet(bottomSheetToggle,vehiclePlayBackAndTrace,10);
    ...
    public FleetTrackingScreen noPilotAssigned()   {
        Assert.assertTrue(actions.iselementVisible(bottomSheetToggle));
        actions.pullUpBottomSheet(bottomSheetToggle,vehiclePlayBackAndTrace,10);
        ScreenShotUtils.attachScreenshot();
    ...
    public FleetTrackingScreen allRealTimeVehicleDetails() throws InterruptedException {
        Assert.assertTrue(actions.iselementVisible(bottomSheetToggle));
        actions.pullUpBottomSheet(bottomSheetToggle,vehiclePlayBackAndTrace,10);
        ScreenShotUtils.attachScreenshot();
        validateAllRealTimeOdometer();
        validateAllRealTimeSweetSpot();
        validateAllRealTimeDEFlevel();
    ...
    public void validatePast24HourPerformance() {
        ...
        //Assert.assertTrue(Float.parseFloat(vehicleEfficiency) > 0.0, "Unable to validate vehicle fuel efficiency.");
        ...
        // Assert.assertTrue(Integer.parseInt(vehicleIgnition) > 0, "Unable to validate vehicle vehicle ignition.");
    ...
    public void validateAllRealTimeOdometer() {
       ...
       // Assert.assertTrue(vehicleOdometer.toLowerCase().contains("km"), "Unable to validate odometer");
    ...
    public void validateAllRealTimeSweetSpot() {

        Assert.assertTrue(isDisplayRealTimeSweetSpot.isDisplayed(), "Real time vehicle sweet spot is not display");
        LogReporter.Reporter("Vehicle sweet spot is display");
        String vehicleSweetSpot = vehicleRealTimeSweetSpot.getText();
        LogReporter.Reporter("Vehicle sweet spot is display value is"+vehicleSweetSpot);
        vehicleSweetSpot=vehicleSweetSpot.replace("%","")
                                         .replace(" ","" );
        Assert.assertTrue(Integer.parseInt(vehicleSweetSpot) >= 0, "Unable to validate vehicle sweet spot % ");
        LogReporter.Reporter("The value of vehicles Sweet spot % is " + vehicleSweetSpot);
    }

    public void validateAllRealTimeDEFlevel() {

        Assert.assertTrue(isDisplayRealTimeDEFlevel.isDisplayed(), "Real time vehicle DEF level is not display");
        LogReporter.Reporter("Vehicle DEF level is display");
        String vehicleDEFlevel = vehicleRealTimeDEFlevel.getText();
        LogReporter.Reporter("Vehicle DEF level is display value"+vehicleDEFlevel);
        vehicleDEFlevel=vehicleDEFlevel.replace("%","")
                .replace(" ","" );
        Assert.assertTrue(Integer.parseInt(vehicleDEFlevel) >= 0, "Unable to validate vehicle DEF level % ");
        LogReporter.Reporter("The value of vehicles DEF level % is " + vehicleDEFlevel);
    }

    public FleetTrackingScreen VehicleRealTimeDetails() {
        ...
        displayVehicleSpeed = displayVehicleSpeed.toLowerCase().replace("km/h", " ").trim();
    ...
    public FleetTrackingScreen validateOneVehicleDetails() {
    ...
    public FleetTrackingScreen validateMovingCategory() {
        navigateToFleetTracking();
        LogReporter.Reporter("Clicked on FleetTracking menu");
        waitForAndroidProgresBar(1);
        swichTrackingView(TrackingView.List);
        ...
        ScreenShotUtils.attachScreenshot();
        Assert.assertTrue(movingVehicles.size() > 0, "Size Validation fail for moving Vehicles");
        LogReporter.Reporter("Validated  Moving Vehicles Exist");
        Assert.assertTrue(idleVehicles.isEmpty(), "Element list  for Idles is not empty");
        LogReporter.Reporter("There is no idle Vehicles Exist in this view");
        Assert.assertTrue(notReachableVehicles.isEmpty(), "Element list  for not Reachable is not empty");
        LogReporter.Reporter("There is no Not Reachable Vehicles Exist in this view");
        Assert.assertTrue(stoppedVehicles.isEmpty(), "Element list for stopped Vehicles  is not empty");
        LogReporter.Reporter("There is no Not stopped Vehicles Exist in this view");
        navigateToHome();
        return this;
    }

    public FleetTrackingScreen validateIdleCategory() {
        navigateToFleetTracking();
        LogReporter.Reporter("Clicked on FleetTracking menu");
        waitForAndroidProgresBar(1);
        swichTrackingView(TrackingView.List);
        ...
        Assert.assertTrue(movingVehicles.isEmpty(), "Element list for Moving is not empty");
        LogReporter.Reporter("There is no  Moving Vehicles Exist in this view");
        Assert.assertTrue(idleVehicles.size() > 0, "Size Validation fails for idle Vehicles");
        Assert.assertTrue(notReachableVehicles.isEmpty(), "Element list for not Reachable  is not empty");
        LogReporter.Reporter("There is no Not Reachable Vehicles Exist in this view");
        Assert.assertTrue(stoppedVehicles.isEmpty(), "Element list for stopped vehicles is not empty");
        LogReporter.Reporter("There is no Stopped  Vehicles Exist in this view");
        navigateToHome();
        return this;
    }

    public FleetTrackingScreen validateStoppedCategory() {
        navigateToFleetTracking();
        LogReporter.Reporter("Clicked on FleetTracking menu");
        waitForAndroidProgresBar(1);
        swichTrackingView(TrackingView.List);
        ...
        Assert.assertTrue(movingVehicles.isEmpty(), "Element list for moving vehicles is not empty");
        LogReporter.Reporter("There is no moving  Vehicles Exist in this view");
        Assert.assertTrue(idleVehicles.isEmpty(), "Element list for idle vehicles is not empty");
        LogReporter.Reporter("There is no idle Vehicles Exist in this view");
        Assert.assertTrue(notReachableVehicles.isEmpty(), "Element list for not reachable  is not empty");
        LogReporter.Reporter("There is no not reachable  Vehicles Exist in this view");
        Assert.assertTrue(stoppedVehicles.size() > 0, "size validation fails for stopped vehicles");
        navigateToHome();
        return this;
    }

    public FleetTrackingScreen navigateToHome() {
    ...
    public FleetTrackingScreen swichTrackingView(TrackingView view) {
        switch (view) {

            case List:
                Assert.assertTrue(actions.iselementVisible(listView), "View is already selected List View - Unable to change again");
                listView.click();
    ...
    public FleetTrackingScreen validateNotReachable() {
        navigateToFleetTracking();
        LogReporter.Reporter("Clicked on FleetTracking menu");
        waitForAndroidProgresBar(1);
        swichTrackingView(TrackingView.List);
        ...
        Assert.assertTrue(stoppedVehicles.isEmpty(), "Element list  for stopped vehicles is not empty");
        LogReporter.Reporter("There is no Stopped  Vehicles Exist in this view");
        Assert.assertTrue(notReachableVehicles.size() > 0, "Size validation is fails for not reachable vehicles");
        navigateToHome();
        return this;
    }
    ...
    public void openClusterVehicleMap() {
        ...
        LogReporter.Reporter("Clicking On vehicle clustor");
        ScreenShotUtils.attachScreenshot();
